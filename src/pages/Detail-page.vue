        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <ol class="breadcrumb justify-content-start mb-4">
                    ...
                    <li class="breadcrumb-item"><router-link to="#">Pages</router-link></li>
                    <li class="breadcrumb-item active text-dark">Single Page</li>
                </ol>
                <div class="row g-4">
                    <div class="col-lg-8">
                        <div class="mb-4">
                            <router-link to="#" class="h1 display-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</router-link>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <router-link to="#" class="text-dark link-hover me-3"><i class="fa fa-clock"></i> 06 minute read</router-link>
                            <router-link to="#" class="text-dark link-hover me-3"><i class="fa fa-eye"></i> 3.5k Views</router-link>
                            <router-link to="#" class="text-dark link-hover me-3"><i class="fa fa-comment-dots"></i> 05 Comment</router-link>
                            <router-link to="#" class="text-dark link-hover"><i class="fa fa-arrow-up"></i> 1.5k Share</router-link>
                        </div>
                        ...
                        <div class="tab-class">
                            <div class="d-flex justify-content-between border-bottom mb-4">
                                <ul class="nav nav-pills d-inline-flex text-center">
                                    ...
                                    <li class="nav-item mb-3">
                                        <router-link class="d-flex py-2 bg-light rounded-pill active me-2" data-bs-toggle="pill" to="#tab-1">
                                            <span class="text-dark" style="width: 100px;">Sports</span>
                                        </router-link>
                                    </li>
                                    <li class="nav-item mb-3">
                                        <router-link class="d-flex py-2 bg-light rounded-pill me-2" data-bs-toggle="pill" to="#tab-2">
                                            <span class="text-dark" style="width: 100px;">Magazine</span>
                                        </router-link>
                                    </li>
                                    <li class="nav-item mb-3">
                                        <router-link class="d-flex py-2 bg-light rounded-pill me-2" data-bs-toggle="pill" to="#tab-3">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center p-3 bg-white rounded">
                                        ...
                                        <div class="ms-3">
                                            <router-link to="#" class="h5 mb-2">Lorem Ipsum is simply dummy text of the printing</router-link>
                            ...
                            <div class="p-4 bg-white rounded mb-4">
                                <div class="row g-4">
                                    ...
                                    <div class="col-9">
                                        <div class="d-flex justify-content-between">
                                            <h5>James Boreego</h5>
                                            <router-link to="#" class="link-hover text-body fs-6"><i class="fas fa-long-arrow-alt-right me-1"></i> Reply</router-link>
                                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="p-3 rounded border">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-12">
                                            <router-link to="#" class="link-hover btn btn-light w-100 rounded text-uppercase text-dark py-3">
                                                Life Style
                                            </router-link>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <router-link to="#" class="link-hover btn btn-light w-100 rounded text-uppercase text-dark py-3 mb-4">
                                                travel & tourism
                                            </router-link>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-12">
                                            <router-link to="#" class="w-100 rounded btn btn-primary d-flex align-items-center p-3 mb-2">
                                                <i class="fab fa-facebook-f btn btn-light btn-square rounded-circle me-3"></i>
                                                <span class="text-white">13,977 Fans</span>
                                            </router-link>
                                            <router-link to="#" class="w-100 rounded btn btn-danger d-flex align-items-center p-3 mb-2">
                                                <i class="fab fa-twitter btn btn-light btn-square rounded-circle me-3"></i>
                                                <span class="text-white">21,798 Follower</span>
                                            </router-link>
                                            <router-link to="#" class="w-100 rounded btn btn-warning d-flex align-items-center p-3 mb-2">
                                                <i class="fab fa-youtube btn btn-light btn-square rounded-circle me-3"></i>
                                                <span class="text-white">7,999 Subscriber</span>
                                            </router-link>
                                            <router-link to="#" class="w-100 rounded btn btn-dark d-flex align-items-center p-3 mb-2">
                                                <i class="fab fa-instagram btn btn-light btn-square rounded-circle me-3"></i>
                                                <span class="text-white">19,764 Follower</span>
                                            </router-link>
                                            <router-link to="#" class="w-100 rounded btn btn-secondary d-flex align-items-center p-3 mb-2">
                                                <i class="bi-cloud btn btn-light btn-square rounded-circle me-3"></i>
                                                <span class="text-white">31,999 Subscriber</span>
                                            </router-link>
                                            <router-link to="#" class="w-100 rounded btn btn-warning d-flex align-items-center p-3 mb-4">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-12">
                                            <router-link to="#" class="link-hover btn border border-primary rounded-pill text-dark w-100 py-3 mb-4">View More</router-link>
                                        </div>
                                        <div class="col-lg-12">
                                            ...
                                            <ul class="nav nav-pills d-inline-flex text-center mb-4">
                                                <li class="nav-item mb-3">
                                                    <router-link class="d-flex py-2 bg-light rounded-pill me-2" to="#">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="position-relative banner-2">
                                                ...
                                                <div class="text-center banner-content-2">
                                                    ...
                                                    <router-link to="#" class="btn btn-primary text-white px-4">Shop Now</router-link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
