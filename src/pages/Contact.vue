                    ...
                    <div class="row g-4">
                        <div class="col-lg-5">
                            <div class="">
                                ...
                                <p class="mb-4">The contact form is currently inactive. Get a functional and working contact form with Ajax & PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <router-link to="https://htmlcodex.com/contact-form">Download Now</router-link>.</p>
                                <div class="rounded">
                                ...
                                <div class="col-xl-6">
                                    <div class="d-flex p-4 rounded bg-white">
                                        ...
                                        <div>
                                            <h4>Share</h4>
                                            <div class="d-flex">
                                                <router-link class="me-3" to=""><i class="fab fa-twitter text-dark link-hover"></i></router-link>
                                                <router-link class="me-3" to=""><i class="fab fa-facebook-f text-dark link-hover"></i></router-link>
                                                <router-link class="me-3" to=""><i class="fab fa-youtube text-dark link-hover"></i></router-link>
                                                <router-link class="" to=""><i class="fab fa-linkedin-in text-dark link-hover"></i></router-link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
